...
function AlbumDetails(){
    ...
    const handleShare=async()=>{
        ...
        try {
            ...
            alert("Album share successfully")
            setShareEmail("")
    ...
    return (
        <div className="container py-4">
            <div className="d-flex justify-content-between align-items-center mb-4">
                ...
                {isOwner && (
                    <button type="button" className="btn btn-outline-primary" onClick={()=>setShowShareModal(true)}>
                            ...
                            <div className="modal-body">
                                ...
                                <input 
                                 ...
                                 <small className="text-secondary">
                                    Enter the email address of the user you want to share this album with.
                                </small>
                            </div>
                            <div className="modal-footer">
                                <button 
